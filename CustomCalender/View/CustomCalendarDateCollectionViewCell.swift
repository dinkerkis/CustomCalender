...
class CustomCalendarDateCollectionViewCell: UICollectionViewCell {
  ...
  static let reuseIdentifier = String(describing: CustomCalendarDateCollectionViewCell.self)
...
// MARK: - Appearance
private extension CustomCalendarDateCollectionViewCell {
  // 1
